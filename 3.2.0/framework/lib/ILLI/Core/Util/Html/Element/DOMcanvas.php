<?PHP
	...
	CLASS DOMcanvas EXTENDS \ILLI\Core\Util\Html\Element
	IMPLEMENTS
	...
	{
		CONST close	= TRUE;
		CONST name	= __name_Element::DOM_canvas;
		
		protected static $__tContent =
		[
			// 'ILLI\Core\Util\Html\IContent\ITransparent',
			'ILLI\Core\Util\Html\IContent\IContent',
			'ILLI\Core\Util\Html\Element\DOMa',
			'ILLI\Core\Util\Html\Element\DOMbutton',
			'ILLI\Core\Util\Html\Element\DOMinput',
