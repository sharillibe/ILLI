<?PHP
	...
	USE ILLI\Core\Std\Def\ADTFunction\ComponentMethodCallException;
	USE ILLI\Core\Std\Def\ADTFunction\ComponentInitializationException;
	USE Exception;
	...
	FINAL CLASS ADTFunction EXTENDS \ILLI\Core\Std\Def\ADT
	{
		#:ILLI\Core\Std\Def\ADT:
			/**
			 * Instantiate a new Abstract Data Type Definition of function.
			 *
			 * @catchable	ILLI\Core\Std\Def\ADTFunction\ComponentInitializationException
			 */
			 ...
			 * value validation
			 *
			 * The value is of type string and a declared function.
			 *
			 * @param	mixed $__value
			 * @return	boolean
			 * @catchable	ILLI\Core\Std\Def\ADTFunction\ComponentInitializationException
			 * @throws	ILLI\Core\Std\Def\ADTFunction\ComponentInitializationException::ERROR_M_VALIDATE
