<?PHP
	...
	FINAL CLASS ADTString EXTENDS \ILLI\Core\Std\Def\ADT
	{
		#:ILLI\Core\Std\Def\ADT:
			/**
			 * Instantiate a new Abstract Data Type Definition of string.
			 *
			 * @catchable	ILLI\Core\Std\Def\ADTString\ComponentInitializationException
			 */
			 ...
			 * value validation
			 *
			 * The type of given value equals with __const_Type::SPL_STRING.
			 *
			 * @param	mixed $__value
			 * @return	boolean
			 * @catchable	ILLI\Core\Std\Def\ADTString\ComponentInitializationException
			 * @throws	ILLI\Core\Std\Def\ADTString\ComponentInitializationException::ERROR_M_VALIDATE
