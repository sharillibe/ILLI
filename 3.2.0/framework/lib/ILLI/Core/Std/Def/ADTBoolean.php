<?PHP
	...
	USE ILLI\Core\Std\Def\ADTBoolean\ComponentMethodCallException;
	USE ILLI\Core\Std\Def\ADTBoolean\ComponentInitializationException;
	USE Exception;
	...
	FINAL CLASS ADTBoolean EXTENDS \ILLI\Core\Std\Def\ADT
	{
		#:ILLI\Core\Std\Def\ADT:
			/**
			 * Instantiate a new Abstract Data Type Definition of boolean.
			 *
			 * @catchable	ILLI\Core\Std\Def\ADTBoolean\ComponentInitializationException
			 */
			 ...
			 * value validation
			 *
			 * The type of given value equals with __const_Type::SPL_BOOLEAN.
			 *
			 * @param	mixed $__value
			 * @return	boolean
			 * @catchable	ILLI\Core\Std\Def\ADTBoolean\ComponentInitializationException
			 * @throws	ILLI\Core\Std\Def\ADTBoolean\ComponentInitializationException::ERROR_M_VALIDATE
