<?PHP
	...
	CLASS ADVResource EXTENDS \ILLI\Core\Std\Def\ADV
	{
		#:ILLI\Core\Std\Def\ADV:
			/**
			 * Instantiate a new ADT-Value-Pair for value of type resource.
			 *
			 * @param	resource	$__data		the initial data
			 * @catchable	ILLI\Core\Std\Def\ADVResource\ComponentInitializationException
			 */
